            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => setShowAddress(!showAddress)} className="text-primary hover:bg-primary/10 hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddress && (
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-indigo-600 transition">
                    {paymentOption === "COD" ? "Place Order" : "Prceed to Payment"}
                </button>
            </div>
        </div>
    ) : null
